...
function App() {
  ...
  return (
    <div className="w-screen h-screen bg-[#4D0012] flex items-center justify-center">
      <div className="bg-white p-8 rounded-3xl shadow w-lghh flex items-center justify-center flex-col gap-4">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-linear-to-br from-[#450010] to-[#6a0018] rounded-2xl mb-4 shadow-lg">
          ...
          <p className="text-lg text-gray-500">
            Não tem uma conta?       Que pena! Espero que você melhore.      </p>
